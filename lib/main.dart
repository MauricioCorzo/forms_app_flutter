...
class HandleNotificationInteractions extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _HandleNotificationInteractions();
}

class _HandleNotificationInteractions
  ...
  void _handleMessage(RemoteMessage message) {
    ...
    appRouter.push("/notifications-details/$messageId");

    print('A new message arrived: ${message.data}');
  }
